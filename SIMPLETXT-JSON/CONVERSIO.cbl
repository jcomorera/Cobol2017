	   ...
	   ENVIRONMENT DIVISION.
		...
		FILE-CONTROL.
			...
			STATUS IS FS-INFILE.
			SELECT OUTFILE ASSIGN "CONVERSIO.json"
			ORGANIZATION IS LINE SEQUENTIAL
	  ...
	  WORKING-STORAGE SECTION.	
		...
		01 ESCRIBIR-LINIA.
		   05 FILLER		PIC X(16) VALUE "{""NOMBRE"" : """.
         	   05 WR-NUMERO 	PIC X(7).
		   05 FILLER		PIC X(3) VALUE """,".
         	   05 FILLER		PIC X(17) VALUE """APELLIDO"" : """.
         	   05 WR-COGNOM 	PIC X(20).
         	   05 FILLER		PIC X(3) VALUE """,".
		   05 FILLER		PIC X(16) VALUE """ZONAGEO"" : """.
        	   05 WR-ZGEO 		PIC X(09).
		   05 FILLER		PIC X(3) VALUE """,".
		   05 FILLER		PIC X(17) VALUE """CANTIDAD"" : """.
		   05 WR-CONTADOR 	PIC 9(02).
		   05 FILLER		PIC X(3) VALUE """ }".
