	...
	PROCES.
		EVALUATE TRUE
			WHEN ID1 = ID2
				...
				IF ID2 = VALORID02 AND VALORID01 IS >= ID2
					PERFORM PROCES1-N
						UNTIL VALORID02 NOT EQUAL TO ID2
				ELSE
					NEXT SENTENCE
				END-IF	
			...
			WHEN ID1 < ID2
				...
				WRITE REG-SORTIDA FROM MSG-MENOR BEFORE ADVANCING 1 LINE
				PERFORM LLEGIR-FITXER1
				
			WHEN ID1 > ID2
				MOVE CUENTA TO MSG-MAJOR-CUENTA
				WRITE REG-SORTIDA FROM MSG-MAJOR BEFORE ADVANCING 1 LINE
				PERFORM LLEGIR-FITXER2
